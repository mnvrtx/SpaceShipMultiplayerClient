...
public class SmartFontGenerator {
	...
	public BitmapFont createFont(FileHandle fontFile, String fontName, int fontSize, String characters) {
	 ...
	 * @param fontSize
	 */
	private BitmapFont generateFontWriteFiles(String fontName, FileHandle fontFile, int fontSize, int pageWidth, int pageHeight, String characters) {
