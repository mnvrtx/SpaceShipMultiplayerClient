...
public abstract class BaseTransactionExecutor {
    ...
    public void execute(Channel channel, ByteBuf byteBuf){
        byte[] bytes = transactionHelper.readByteBufAndDispose(byteBuf);
        transactionHelper.fillTransaction(bytes, transactionForComparing);
        ...
        BaseTransaction concreteTransaction = transactionHelper.findAppropriateTransaction(bytes);
        ...
        transactionHelper.fillTransaction(bytes, concreteTransaction);
